...
import { ProfitLossReportsTable } from "./components/ProfitLossReportsTable";
import { ProfitLossReportList } from "./components/ProfitLossReportList/ProfitLossReportList";
ChartJS.register(
  ArcElement,
  Tooltip,
  Legend,
  ...
  return (
    <main className="p-4 md:p-8">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6">
        ...
        />
        <ProfitLossReportsTable data={productsData} />
        <ProfitLossReportList data={productsData} />
      </div>

      <div className="w-full my-6 flex flex-col md:flex-row justify-between items-start gap-6">
        <div className="w-full md:w-1/2 bg-white rounded-2xl shadow-md p-4 flex flex-col justify-between">
      ...
      <div className="w-full my-6 flex flex-col md:flex-row justify-between items-start gap-6">
        <div className="w-full md:w-5/7 bg-white rounded-2xl shadow-md p-4 flex flex-col justify-between">
          <div className="mb-4 flex flex-row justify-start items-center">
            <FaChartBar className="mr-6 text-xl" />
        ...
        <div className="w-full md:w-2/7 aspect-square bg-white rounded-2xl shadow-md p-4 flex flex-col justify-between">
          <div className="mb-4 flex flex-row justify-start items-center">
