...
import { PerformanceReportList } from "./components/PerformanceReportList/PerformanceReportList";
ChartJS.register(
  ArcElement,
  Tooltip,
  Legend,
    ...
    <main className="p-4 md:p-8">
      <div className="bg-white rounded-2xl shadow-md p-6">
        <div className="w-full flex flex-row justify-between items-center">
          <h3 className="text-2xl font-medium">Product Performance</h3>
      ...
      <div className="bg-white rounded-2xl shadow-md p-6">
        ...
        />
        <PerformanceReportTable data={productsData} />
        <PerformanceReportList data={productsData} />
      </div>
      ...
      <div className="w-full my-6 flex flex-col md:flex-row justify-between items-start gap-6">
        <div className="w-full md:w-1/2 bg-white rounded-2xl shadow-md p-4 flex flex-col justify-between">
          <div className="mb-4 flex flex-row justify-start items-center">
            ...
            <h4 className="text-lg font-semibold">Top 10 Products by Sales</h4>
          </div>
      ...
      <div className="w-full my-6 flex flex-col md:flex-row justify-between items-start gap-6">
        ...
        <div className="w-full md:w-1/2 bg-white rounded-2xl shadow-md p-4 flex flex-col justify-between">
          <div className="mb-4 flex flex-row justify-start items-center">
            ...
            <h4 className="text-lg font-semibold">Product Turnover Rate</h4>
          </div>
