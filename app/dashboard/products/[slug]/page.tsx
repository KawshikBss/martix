        ...
        <div className="w-2/3 bg-white rounded-2xl shadow-md p-6">
          <div className="w-full flex flex-row justify-start items-start gap-6 mb-6">
            ...
            <div className="w-1/2">
              ...
              <h5 className="text-md text-gray-500 mb-4">{product.sku}</h5>
              <p className="text-gray-700 mb-4">
                {categoriesData[0].name} {">"}{" "}
                {categoriesData[0]?.children?.[0]?.name}
              </p>
              <div className="mb-4 flex flex-row flex-wrap justify-start items-center gap-4">
                <span className="px-4 py-1 rounded-full text-white bg-green-500">
                  Medicine
                </span>
                <span className="px-4 py-1 rounded-full text-white bg-green-500">
                  Tablet
      ...
      <div className="w-full flex flex-row justify-between items-start gap-6 my-6">
        <div className="w-1/2 bg-white rounded-2xl shadow-md p-6">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-gray-300 text-gray-500">
                  ...
                  <th className="px-2 py-2 font-normal text-center">Price</th>
                  <th className="px-2 py-2 font-normal text-center">
                    Stock Qty
                  </th>
                  <th className="px-2 py-2 font-normal text-center">Status</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-300 hover:bg-gray-50">
                  <td className="px-1 py-2 text-center">Variant name</td>
                  <td className="px-1 py-2 text-center">vb-001</td>
                  <td className="px-1 py-2 text-center">100</td>
                  <td className="px-1 py-2 text-center">20</td>
                  <td className="px-1 py-2 text-center">In Stock</td>
                </tr>
                <tr className="border-b border-gray-300 hover:bg-gray-50">
                  <td className="px-1 py-2 text-center">Variant name</td>
                  <td className="px-1 py-2 text-center">vb-001</td>
          ...
          <div className="my-2 w-full flex flex-row justify-between items-start gap-6">
            <div className="w-1/2">
              <h3 className="text-xl font-bold my-2">Tax / VAT Settings</h3>
            ...
            <div className="w-1/2">
              ...
              <div className="my-4 bg-gray-50 rounded-xl p-2 shadow-sm">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-sm text-gray-900">12 Sept 2025</div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm text-gray-900">vb-001</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-1/2 bg-white rounded-2xl shadow-md p-6">
          ...
          <div className="relative max-h-[200px] overflow-y-scroll my-6">
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-gray-300 text-gray-500">
                  <th className="px-2 py-2 font-normal text-center">Date</th>
                  <th className="px-2 py-2 font-normal text-center">Action</th>
                  <th className="px-2 py-2 font-normal text-center">Qty</th>
                  <th className="px-2 py-2 font-normal text-center">
                    Remaining
                  </th>
                  <th className="px-2 py-2 font-normal text-center">User</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-300 hover:bg-gray-50">
                  <td className="px-1 py-2 text-center">18 Aug 25</td>
                  <td className="px-1 py-2 text-center">Sale</td>
                  <td className="px-1 py-2 text-center">-5</td>
                  <td className="px-1 py-2 text-center">20</td>
                  <td className="px-1 py-2 text-center">Staff A</td>
                </tr>
                <tr className="border-b border-gray-300 hover:bg-gray-50">
                  <td className="px-1 py-2 text-center">18 Aug 25</td>
                  <td className="px-1 py-2 text-center">Sale</td>
