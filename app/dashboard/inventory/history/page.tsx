...
import { StockAdjustmentsHistoryTable } from "./components/StockAdjustmentsHistoryTable";
import { StockAdjustmentsHistoryList } from "./components/StockAdjustmentsHistoryList/StockAdjustmentsHistoryList";
ChartJS.register(
  ArcElement,
  Tooltip,
  Legend,
...
export default function AdjustmentsHistory() {
  return (
    <main className="p-4 md:p-8">
      ...
      <StockAdjustmentsHistoryTable data={productsData} />
      <StockAdjustmentsHistoryList data={productsData} />
