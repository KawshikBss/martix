...
const InventoriesFilterModal = ({ show, onClose }: Props) => {
    ...
    const resetFilters = () => {
        setFilters({
            ...
            min_inventory_value: "",
            max_inventory_value: "",
            has_expired_products: false,
            has_soon_expiring_products: false,
            min_create_date: "",
            max_create_date: "",
            min_update_date: "",
            max_update_date: "",
    ...
    return (
        <DashboardModal title="Filter Stocks" show={show} onClose={onClose}>
...
export default InventoriesFilterModal;
