...
const InventoryMovementsFilterModal = ({ show, onClose }: Props) => {
    ...
    return (
        <DashboardModal title="Filter Movements" show={show} onClose={onClose}>
...
export default InventoryMovementsFilterModal;
