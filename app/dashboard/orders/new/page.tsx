...
import ProductsGrid from "../../components/pos/ProductsGrid/ProductsGrid";
import Loader from "@/components/ui/loaders/Loader";
import ProductsFilterModal from "../../products/components/ProductsFilterModal";
import SideCart from "../../components/pos/SideCart/SideCart";
...
export default function NewOrder() {
    ...
    return (
        <main className="p-4 md:p-8">
            <h3 className="text-2xl font-medium">New Sale Order</h3>
