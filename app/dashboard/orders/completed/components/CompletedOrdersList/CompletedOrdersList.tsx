...
import { CompletedOrdersListItem } from "./CompletedOrdersListItem";

export interface ICompletedOrdersListProps {
  data: IProduct[];
}

export function CompletedOrdersList(props: ICompletedOrdersListProps) {
  return (
        ...
        <>
          ...
          <div className="space-y-4 mt-4">
            {props.data.map((product) => (
              <CompletedOrdersListItem key={product.id} product={product} />
            ))}
          </div>
