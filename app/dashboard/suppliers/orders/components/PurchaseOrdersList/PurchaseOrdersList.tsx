...
export interface IPurchaseOrdersListProps {
  data: Order[];
}

export function PurchaseOrdersList(props: IPurchaseOrdersListProps) {
  return (
        ...
        <>
          ...
          <div className="space-y-4 mt-4">
            {props.data.map((product) => (
              <PurchaseOrdersListItem key={product.id} product={product} />
            ))}
          </div>
